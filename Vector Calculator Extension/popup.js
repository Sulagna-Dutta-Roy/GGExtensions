...
function calc() {
    ...
    switch (operation) {
        case "add":
            const cx_add = ax + bx;
            const cy_add = ay + by;
            result = `Sum of the two vectors is = <${cx_add}, ${cy_add}>`;
            break;
        case "subtract":
            const cx_subtract = ax - bx;
            const cy_subtract = ay - by;
            result = `Difference of the two vectors is = <${cx_subtract}, ${cy_subtract}>`;
            break;
        case "dot":
            ...
            result = `Dot Product of the two vectors is = ${dotProduct}`;
