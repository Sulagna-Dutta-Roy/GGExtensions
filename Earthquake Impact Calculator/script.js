document.getElementById('earthquakeForm').addEventListener('submit', function(e) {
    ...
    document.getElementById('pga').innerText = `Peak Ground Acceleration (PGA): ${pga.toFixed(2)} g`;
    document.getElementById('mmi').innerText = `Modified Mercalli Intensity (MMI): ${mmi}`;
    document.getElementById('damageLevels').innerText = `Estimated Damage Levels: ${damageLevels}`;
    document.getElementById('affectedPopulation').innerText = `Estimated Affected Population: ${affectedPopulation}`;
