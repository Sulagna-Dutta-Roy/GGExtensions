 ...
 * @author Krcma
 */
public class SniperGunBlock implements Block, Serializable {
    ...
    private final BlockType TYPE = BlockType.SNIPER_GUN;

    public SniperGunBlock(Point offset_position, Color color) {
    ...
    public void render(Graphics2D g2, boolean fromDown, boolean upper, int x_off, int y_off) {
        ...
        if (!upper) {
            ...
            if (fromDown) {
                ...
                g2.setColor(Tools.darkerColor(this.COLOR));
                g2.fillPolygon(
                        new int[]{x + (int) (Block.SIZE * 0.1f), x + (int) (Block.SIZE * 0.5f), x + (int) (Block.SIZE * 0.9f)},
                        new int[]{y + (int) (Block.SIZE * 0.9f), y + (int) (Block.SIZE * 0.1f), y + (int) (Block.SIZE * 0.9f)},
                        3
                );
            } else {
                g2.setColor(g2.getColor().darker());
                g2.drawLine(
                        ...
                        (int) (y + Block.SIZE * 0.5f),
                        (int) (x + Block.SIZE * 0.5f),
                        (int) (y + Block.SIZE * 1.5f)
                );
                g2.setStroke(new BasicStroke(5));
                g2.drawLine(
                        (int) (x + Block.SIZE * 0.5f),
                        (int) (y + Block.SIZE * 1.4f),
                        (int) (x + Block.SIZE * 0.5f),
                        (int) (y + Block.SIZE * 1.5f)
                );
                g2.setStroke(new BasicStroke(3));
                ...
                g2.fillPolygon(
                        new int[]{x + (int) (Block.SIZE * 0.1f), x + (int) (Block.SIZE * 0.5f), x + (int) (Block.SIZE * 0.9f)},
                        new int[]{y + (int) (Block.SIZE * 0.1f), y + (int) (Block.SIZE * 0.9f), y + (int) (Block.SIZE * 0.1f)},
                        3
                );
            }
        }
