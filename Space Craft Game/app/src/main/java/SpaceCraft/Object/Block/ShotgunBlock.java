 ...
 * @author Krcma
 */
public class ShotgunBlock implements Block, Serializable {
    ...
    private final BlockType TYPE = BlockType.SHOTGUN;

    public ShotgunBlock(Point offset_position, Color color) {
    ...
    public void render(Graphics2D g2, boolean fromDown, boolean upper, int x_off, int y_off) {
        ...
        if (!upper) {
            ...
            if (fromDown) {
                g2.fillRect(
                        (int) (x + Block.SIZE * 0.25f),
                        (int) (y - Block.SIZE * 0.2f),
                        (int) (Block.SIZE * 0.2f),
                        (int) (Block.SIZE * 0.8f)
                );
                g2.fillRect(
                        (int) (x + Block.SIZE * 0.55f),
                        (int) (y - Block.SIZE * 0.2f),
                        (int) (Block.SIZE * 0.2f),
                        (int) (Block.SIZE * 0.8f)
                );
                g2.fillRect(
                        (int) (x + Block.SIZE * 0.2f),
                        (int) (y),
                        (int) (Block.SIZE * 0.6f),
                        (int) (Block.SIZE * 0.1f)
                );
                ...
                g2.fillRect(
                        (int) (x + Block.SIZE * 0.2f),
                        (int) (y + Block.SIZE * 0.9),
                        (int) (Block.SIZE * 0.6f),
                        (int) (Block.SIZE * 0.1f)
                );
                g2.fillRect(
                        (int) (x + Block.SIZE * 0.2f),
                        (int) (y + Block.SIZE * 1.25f),
                        (int) (Block.SIZE * 0.6f),
                        (int) (Block.SIZE * 0.2f)
                );
                g2.setColor(Tools.darkerColor(this.COLOR));
