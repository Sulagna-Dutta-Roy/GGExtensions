 ...
 * @author Krcma
 */
public class TripleGunBlock implements Block, Serializable {
    ...
    private final BlockType TYPE = BlockType.TRIPLE_GUN;

    public TripleGunBlock(Point offset_position, Color color) {
