 ...
 * @author Krcma
 */
public class NormalBlock implements Block, Serializable {
    ...
    private final BlockType TYPE = BlockType.NORMAL;

    public NormalBlock(Point offset_position, Color color) {
