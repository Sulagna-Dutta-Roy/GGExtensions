 ...
 * @author Krcma
 */
public class LaserGunBlock implements Block, Serializable {
    ...
    private BlockType TYPE = BlockType.LASER_GUN;

    public LaserGunBlock(Point offset_position, Color color) {
