 ...
 * @author Krcma
 */
public class ShieldBlock implements Block, Serializable {
    ...
    private final BlockType TYPE = BlockType.SHIELD_BLOCK;
    public int shield = 100;

    public ShieldBlock(Point offset_position, Color color) {
    ...
    public void render(Graphics2D g2, boolean fromDown, boolean upper, int x_off, int y_off) {
        if (!upper) {
            ...
            g2.drawArc(x - (int) (Block.SIZE * 0.4f), y - (int) (Block.SIZE * 0.4f), (int) (Block.SIZE * 0.8f), (int) (Block.SIZE * 0.8f), 270, 90);
            g2.drawArc(x + (int) (Block.SIZE * 0.6f), y - (int) (Block.SIZE * 0.4f), (int) (Block.SIZE * 0.8f), (int) (Block.SIZE * 0.8f), 180, 90);
            g2.drawArc(x - (int) (Block.SIZE * 0.4f), y + (int) (Block.SIZE * 0.6f), (int) (Block.SIZE * 0.8f), (int) (Block.SIZE * 0.8f), 0, 90);
            g2.drawArc(x + (int) (Block.SIZE * 0.6f), y + (int) (Block.SIZE * 0.6f), (int) (Block.SIZE * 0.8f), (int) (Block.SIZE * 0.8f), 90, 90);
