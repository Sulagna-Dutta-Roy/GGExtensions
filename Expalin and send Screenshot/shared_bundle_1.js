...
`;
template$jason.setAttribute('style', 'display: none;');
document.head.appendChild(template$jason.content);
...
document.head.appendChild(template$9.content); /// BareSpecifier=@polymer\paper-button\paper-button
...
document.head.appendChild(style); /// BareSpecifier=@polymer\iron-form-element-behavior\iron-form-element-behavior
...
document.head.appendChild(template$4.content); /// BareSpecifier=@polymer\paper-item\paper-item-shared-styles
...
document.head.appendChild($_documentContainer.content); /// BareSpecifier=@polymer\paper-item\paper-item
...
document.head.appendChild(template$5.content); /// BareSpecifier=@polymer\paper-menu-button\paper-menu-button
